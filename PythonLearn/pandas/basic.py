...
print(" if type is same that each of data in same column, column type is defined automatically.")
print(df)
print("")
...
df = pd.DataFrame([[10,True,30,None],
                   ["acb",2,{},4],
                   [2.4,200,300,400]])
print(" if type is different that each of data in same column, column type become object automatically.")
print(df)
print("")
...
print("dataframe can be setted index names and column names.")
...
#if you want to naming indice and columns that create dataframe same times,
#you can be coding about below...
df = pd.DataFrame(np.arange(100).reshape((25,4)),
...
#AndAlso, you can create dataframe with dict object, based columns.
#If column length is different each other, value error has occured.
